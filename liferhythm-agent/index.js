 ...
 *   node index.js -i
 *
 *   # Morning briefing (what's due today, overdue, and upcoming)
...
async function runBriefing(agent) {
  console.log('Generating your morning briefing...\n');
  try {
    const { response, actions } = await agent.process(
